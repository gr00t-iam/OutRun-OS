/* Freestanding Mbed TLS 3.6 LTS: TLS 1.2 ECDHE_RSA/ECDHE_ECDSA AES-GCM.
 * No filesystem, weak entropy, wallclock bypass or certificate bypass. */
#ifndef OUTRUN_MBEDTLS_CONFIG_H
#define OUTRUN_MBEDTLS_CONFIG_H
...
#define MBEDTLS_SHA1_C /* Legacy root self-signatures; leaf profile still rejects SHA-1. */
